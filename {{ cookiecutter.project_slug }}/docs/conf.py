...
version = {{ cookiecutter.python_slug }}.__version__
# The full version, including alpha/beta/rc tags.
release = {{ cookiecutter.python_slug }}.__version__
...
htmlhelp_basename = "{{ cookiecutter.python_slug }}doc"
...
man_pages = [(main_doc, "{{ cookiecutter.python_slug }}", "{{ cookiecutter.project_slug }} Documentation", [author], 1)]
