...
[![Documentation](https://github.com/JaneCodes/python-boilerplate/workflows/Documentation/badge.svg)](https://python-boilerplate.github.io/python-boilerplate)
...
2. Ensure that you have set GitHub pages to build the `gh-pages` branch by selecting the
   ...
   repository settings.
   ([Repo Settings](https://github.com/JaneCodes/python-boilerplate/settings))
3. Register your project with PyPI:
    - Make an account on [pypi.org](https://pypi.org)
    - Go to your GitHub repository's settings and under the
      [Secrets tab](https://github.com/JaneCodes/python-boilerplate/settings/secrets/actions),
